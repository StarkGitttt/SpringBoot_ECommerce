...
<body>
 		<c:if test="${empty mapProducts }">
 			<h3 class="section-p1">Không có sản phẩm yêu thích</h3>
 		</c:if>
	   <section id="product1" class="section-p1">
		<c:forEach var="products" items="${mapProducts }">
			<div class="mr-top">
	            ...
	            <div class="${products.value.size() < 4 ? 'unslider' : 'slider' }">
		            	<c:forEach var="product" items="${products.value}">
			                ...
			                <a href="/product/like?id=${product.id}&page=favorite">
