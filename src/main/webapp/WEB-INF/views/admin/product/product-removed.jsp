  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Danh sách sản phẩm bị xóa</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách sản phẩm bị xóa</h3>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                  		...
                  		<tr>
	                		...
	                		<td><img src="/assets/images/products/f1.jpg" alt=""></td>
                  			...
                  			<td><a href="/admin/manage/product/restore?id=${ product.id }"><i class="fas fa-undo"></i></a></td>
                  		</tr>
                  		</c:forEach>
                  </tbody>
