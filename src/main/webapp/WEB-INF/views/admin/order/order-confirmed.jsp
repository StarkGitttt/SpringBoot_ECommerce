          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Hóa đơn đã duyệt</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  		...
                  		<tr>
		                    ...
		                    <td>${order.address}, ${order.account.phone }</td>
		                    <td><fmt:formatNumber value="${order.total}" pattern="#,###"></fmt:formatNumber> VNĐ</td>
							<td class="confirmed">Đã xác nhận</td>
		                    <td><a href="/admin/manage/view/details/order?status=confirmed&id=${order.id}">Chi tiết</a></td>
                  		</tr>
                  		</c:forEach>
                  </tbody>
